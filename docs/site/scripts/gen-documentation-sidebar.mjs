...
// Onboard/Scale, and Integrations Guide are flat piles of 15-40 files that
// read badly as one long alphabetical list, so each gets a manual grouping
// override applied at sidebar-render time only — the files themselves stay
// flat on disk, so URLs don't move.
//
